    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <header className="absolute top-0 left-0 right-0 z-30 p-4">
        <div className="container mx-auto flex items-center justify-between text-white">
          {/* LOGO UPDATED: Now hidden on mobile and visible from md screens up */}
          <Link href="/" className="hidden md:flex items-center gap-2">
            <Mountain className="h-7 w-7" />
            <span className="text-xl font-bold">Alpine</span>
          </Link>

          {/* DESKTOP NAVIGATION: This whole nav is hidden on mobile screens */}
      ...
      {/* Main Content */}
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-end pb-20 sm:pb-24 md:pb-32">
