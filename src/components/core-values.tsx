...
const values = [
    {
        id: 'panel-1',
        title: 'Reliability',
        heading: 'Always There For You',
        text: 'You can depend on us to provide a lasting solution, even when it\'s tough. We focus on building long-term relationships.',
        icon: <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="M12 2L4 5v6c0 5.55 3.58 10.42 8 12 4.42-1.58 8-6.45 8-12V5l-8-3z"></path></svg>
    },
    {
        id: 'panel-2',
        title: 'Professionalism',
        heading: 'Excellence in Every Detail',
        text: 'From our appearance to our workmanship, we hold ourselves to the highest standards to ensure our work always stands out.',
    ...
    },
    {
        id: 'panel-3',
        title: 'Courtesy',
        heading: 'Respect for Your Space',
        text: 'We work in your private home or office with the utmost respect for your privacy, convenience, and comfort.',
        icon: <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
    },
    {
        id: 'panel-4',
        title: 'Integrity',
        heading: 'Honest & Transparent',
        text: 'We will not take advantage of our clients. Our services and products will always match our promises, guaranteed.',
        icon: <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 22 12 17 17 22 15.79 13.88"></polyline></svg>
    }
];
    ...
    return (
        <>
            <style jsx>{`
                ...
                .panel-icon-container :global(svg) {
                    width: 48px;
                    height: 48px;
                ...
                #panel-1 { animation-delay: calc(var(--animation-total-duration) * -0.75); }
                #panel-2 { animation-delay: calc(var(--animation-total-duration) * -0.50); }
                #panel-3 { animation-delay: calc(var(--animation-total-duration) * -0.25); }
                #panel-4 { animation-delay: calc(var(--animation-total-duration) * 0); }
                ...
                .intro-finished .step-panel:hover .panel-icon-container :global(svg) {
                    stroke: white;
                }
                ...
                @media (prefers-reduced-motion: reduce) {
                    ...
                    #panel-1 .panel-content { opacity: 1; transform: translateY(0); }
                     #panel-1 .panel-content p, #panel-1 .panel-content h3 { color: white; }
                    #panel-1 .panel-icon-container :global(svg) { stroke: white; }
                }
            `}</style>
            <section className="values-section-wrapper">
                <main className="main-container">
                    ...
                    <section className="steps-container intro-animation" id="steps-section" aria-labelledby="values-section-title" ref={stepsContainerRef}>
                        {values.map(value => (
                            <article className="step-panel" id={value.id} key={value.id}>
